   ...
   public static void main(String[] args)
   {
      ...
      switch (choice)
      {
         case 1:  // Ruppe Conversion
            ...
            dollar = amount / 70;
            System.out.println("\n"+amount + " Rupee = " + f.format(dollar) + " Dollar");
         ...
         case 2:  // Dollar Conversion
            rupee = amount * 70;
            System.out.println("\n"+amount + " Dollar = " + f.format(rupee) + " Ruppes");
         ...
         case 3:  // Pound Conversion
            rupee = amount * 88;
            System.out.println("\n"+amount + " pound = " + f.format(rupee) + " Ruppes");
         ...
         case 4:  // Euro Conversion
            rupee = amount * 80;
            System.out.println("\n"+amount + " euro = " + f.format(rupee) + " Ruppes");
         ...
         case 5:  // Yen Conversion
            rupee = amount *0.63;
            System.out.println("\n"+amount + " yen = " + f.format(rupee) + " Ruppes");
         ...
         case 6:  // Ringgit Conversion
            rupee = amount *16.8;
            System.out.println("\n"+amount + " ringgit = " + f.format(rupee) + " Ruppes");
